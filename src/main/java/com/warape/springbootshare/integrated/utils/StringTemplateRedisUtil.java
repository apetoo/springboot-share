...
* redis 操作工具类
*/
public class StringTemplateRedisUtil {

    private StringRedisTemplate stringRedisTemplate;



    public StringTemplateRedisUtil() {
    }

    public StringTemplateRedisUtil(StringRedisTemplate stringRedisTemplate) {
     ...
     * @return
     */
    public Long batchAddZset(String key,Set<TypedTuple<String>> tuples){
